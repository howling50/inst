...
sudo zypper install -y -n cava w3m ddgr cmus cmus-plugins-all xkill firewall-config tealdeer patterns-devel-base-devel_basis bat zoxide fzf gdu eza ripgrep podman distrobox symbols-only-nerd-fonts fetchmsttfonts meslo-lg-fonts oxygen6-cursors mpv
...
#-----------------------------------------------------------------
#bdinfo-git quickemu quickgui-bin aegisub ytfzf cmatrix mpv
