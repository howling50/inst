...
#------------------------------------------------------------------
sudo flatpak install --noninteractive flathub io.github.giantpinkrobots.varia && sudo flatpak install --noninteractive flathub net.mediaarea.MediaInfo && sudo flatpak install --noninteractive flathub com.github.tchx84.Flatseal && sudo flatpak install --noninteractive flathub org.torproject.torbrowser-launcher
