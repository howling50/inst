...
#sudo zypper in --no-recommends xfce4-terminal xfce4-taskmanager && sudo zypper in numlockx thunar-archive-plugin polkit-gnome htop NetworkManager-applet catfish jq thunar thunar-volman gvfs lxappearance 
