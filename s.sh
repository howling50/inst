...
#sudo zypper in --no-recommends guake numlockx thunar-archive-plugin polkit-gnome htop NetworkManager-applet catfish jq xfce4-taskmanager thunar thunar-volman gvfs lxappearance 
