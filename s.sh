...
#sudo zypper in --no-recommends xfce4-terminal numlockx thunar-archive-plugin polkit-gnome htop NetworkManager-applet catfish jq xfce4-taskmanager thunar thunar-volman gvfs lxappearance 
