...
#sudo zypper in --no-recommends polkit-gnome htop NetworkManager-applet catfish jq xfce4-terminal xfce4-taskmanager ImageMagick thunar thunar-volman gvfs lxappearance 
