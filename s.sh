...
sudo zypper install -y -n cmus cmus-plugins-all xkill firewall-config tealdeer patterns-devel-base-devel_basis bat zoxide fzf gdu eza thefuck ripgrep podman distrobox symbols-only-nerd-fonts fetchmsttfonts meslo-lg-fonts oxygen6-cursors mpv
