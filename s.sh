...
#mkdir -p ~/Media/container/arch && distrobox create -n arch -i quay.io/toolbx/arch-toolbox:latest --nvidia --init --additional-packages "systemd git fzf eza bat starship zoxide neovim ytfzf cmatrix mpv yt-dlp" --home ~/Media/container/arch && distrobox enter arch
