...
#sudo zypper in --no-recommends numlockx thunar-archive-plugin polkit-gnome htop NetworkManager-applet catfish jq xfce4-terminal xfce4-taskmanager thunar thunar-volman gvfs lxappearance 
