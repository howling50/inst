...
\e[1;36mScripts:\e[0m 1, 2, ani-cli, yt-x, timer, checkerror, rofi-wifi-menu, power-menu.sh, dlfile, killandnotify, ipconfig, lastupdate.sh, formatext4.sh, ext4autodefrag, ntfsautodefrag, toggle-stereo-swap.sh, RofiFind.sh
\e[1;33mOther:\e[0m
