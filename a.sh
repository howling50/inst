...
#-----------------------------------------------------
sudo pacman -S procs magic-wormhole binutils nmap gcc patch fakeroot bind yazi gimp mediainfo-gui mediainfo npm xournalpp torbrowser-launcher --noconfirm --needed
