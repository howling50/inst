...
#sudo pacman -S xfce4-panel-profiles xfce4-whiskermenu-plugin xfce4-screenshooter xfce4-taskmanager adwaita-icon-theme baobab file-roller guake --noconfirm --needed && sudo pacman -R parole vim --noconfirm
