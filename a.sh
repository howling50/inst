...
if pacman -Qs plasma-desktop >/dev/null; then
    ...
    sudo pacman -S --noconfirm --needed xorg-xev i3-wm polybar python-i3ipc autotiling i3lock wmctrl xorg-xprop thunar gvfs gvfs-mtp gvfs-afc xfce4-terminal xfce4-taskmanager htop polkit-gnome xorg-xinput network-manager-applet lxappearance
