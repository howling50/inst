...
if pacman -Qs plasma-desktop >/dev/null; then
    ...
    sudo pacman -S --noconfirm --needed xorg-xev i3-wm polybar python-i3ipc autotiling i3lock lxappearance wmctrl xorg-xprop thunar xfce4-terminal xfce4-taskmanager htop polkit-gnome xorg-xinput
