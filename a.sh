...
sudo pacman -S --needed base-devel git --noconfirm --needed && git clone https://aur.archlinux.org/yay-bin.git && cd ~/Downloads/inst/yay-bin && makepkg --noconfirm -si && cd ~/Downloads/inst && yay --sudoloop --save && rm -rf yay-bin
#----Swap-------
...
#-----------------------------------------------------------------
yay -S --noconfirm dxvk-bin ventoy-bin winegui-bin input-remapper-git ttf-ms-fonts dragon-drop heroic-games-launcher-bin urlview reflector-simple
