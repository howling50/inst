...
yay -S --noconfirm ventoy-bin reflector-simple quickemu quickgui-bin winegui cli-visualizer hardinfo2 dxvk-bin input-remapper-git bdinfo-git ttf-ms-fonts
