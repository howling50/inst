...
#wayland = egl-wayland niri qt5ct  qt6ct  nwg-look nwg-displays xdg-desktop-portal xdg-desktop-portal-gtk slurp wlogout swaybg waybar wl-clipboard kvantum xdg-user-dirs libspng python-requests python-pyquery qt6-svg xdg-utils qt5-wayland qt6-wayland kvantum-qt5 wev grim wtype xwayland-satellite swaylock
