...
#-----------------------------------------------------------------
yay -S --noconfirm dxvk-bin ventoy-bin winegui-bin input-remapper-bin ttf-ms-fonts dragon-drop heroic-games-launcher-bin urlview pacseek-bin autobrr-bin zen-browser-bin librewolf-bin varia
...
#sudo pacman -S --noconfirm --needed pipewire pipewire-alsa pipewire-audio pipewire-jack pipewire-pulse gst-plugin-pipewire wireplumber pavucontrol pamixer networkmanager network-manager-applet bluez bluez-utils blueman brightnessctl udiskie sddm qt5-quickcontrols qt5-quickcontrols2 qt5-graphicaleffects hyprland swaync rofi waybar swaybg hyprlock wlogout polkit-gnome xdg-desktop-portal-hyprland xdg-desktop-portal-gtk xdg-user-dirs pacman-contrib jq imagemagick qt5-imageformats ffmpegthumbs libnotify noto-fonts-emoji nwg-look qt5ct qt6ct kvantum kvantum-qt5 qt5-wayland qt6-wayland dolphin nwg-displays wl-clipboard hyprpicker slurp hyprsunset ark && yay -S --noconfirm --needed grimblast-git
