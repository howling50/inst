...
sudo sed -i 's/^#IgnorePkg   =/IgnorePkg = qbittorrent kwalletmanager/' /etc/pacman.conf && sudo usermod -aG gamemode "$(whoami)" && flatpak override com.usebottles.bottles --user --filesystem=xdg-data/applications:create
#-----------------
