...
sudo pacman -S binutils nmap gcc patch fakeroot bind rofi rofi-calc yazi ventoy gimp fbreader dragon-drop perl-image-exiftool easytag --noconfirm --needed
...
#-----------------------------------------------------------------
yay -S --noconfirm dxvk-bin quickemu quickgui-bin winegui-bin input-remapper-git ttf-ms-fonts
