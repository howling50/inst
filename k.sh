...
sudo pacman -S binutils nmap gcc patch fakeroot bind rofi rofi-calc yazi ventoy gimp fbreader dragon-drop perl-image-exiftool easytag shotcut hexchat --noconfirm --needed
