...
#-----------------------------------------------------
sudo pacman -S procs magic-wormhole binutils nmap gcc patch fakeroot bind yazi ventoy gimp fbreader dragon-drop perl-image-exiftool shotcut hexchat gnome-boxes mediainfo-gui mediainfo handbrake torbrowser-launcher --noconfirm --needed
...
#-----------------------------------------------------------------
yay -S --noconfirm dxvk-bin winegui-bin input-remapper-bin ttf-ms-fonts heroic-games-launcher-bin urlview pacseek-bin autobrr-bin varia
