...
#-----------------------------------------------------
sudo pacman -S magic-wormhole binutils nmap gcc patch fakeroot bind yazi ventoy gimp fbreader dragon-drop perl-image-exiftool shotcut hexchat gnome-boxes mediainfo-gui mediainfo handbrake torbrowser-launcher --noconfirm --needed
